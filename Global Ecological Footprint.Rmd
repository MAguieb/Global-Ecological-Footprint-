...
Le résultat montre qu'il y a effectivement 46 lignes avec des valeurs manquantes dans les variables sont les suivantes : ("HDI","GDP_per_Capita","Cropland_Footprint","Grazing_Footprint","Forest_Footprint","Carbon_Footprint",
...
## Etude des Valeurs Abérrantes{.tabset .tabset-fade .tabset-pills}  

Grace à ces boites à moustaches, nous pouvons clairement voir les valeurs extr?mes soit par pays ou bien par r?gion. Dans le boxplot du Population par exemple soit par pays ou bien par region, les valeurs maximales ?taient dans les r?gions Asiatiques, dans l'Afrique et l'Amerique Latine. 
...
## Analyse de la variable Biocapacity Deficit or Reserve par Catégorie{.tabset .tabset-fade .tabset-pills}
...
### Visualisation de Biocapacity GropLand par Pays & Région
...
###Visualisation de Biocapacity Grazing par Pays & Région : 
...
###Visualisation de Biocapacity Forest par Pays & Région : 
...
###visualisation de Biocapacity Fish par Pays & Région : 
...
## Différentes Analyses{.tabset .tabset-fade .tabset-pills}


à partir des graphes illustrées dans cette section,et aussi tout en gardant dans l'?sprit les r?sultats obtennus jusqu'? maintenant, pour les diff?rents variables analys?es (HDI,Population ...etc),on peut dire que ,les r?gions de l'Union europ?enne, du Moyen-Orient, de l'Asie centrale et de l'Am?rique du Nord ont en moyenne une empreinte ?cologique totale ?lev?e dans l'ensemble des cinq empreintes et, en m?me temps, se classent au premier rang de l'HDI.
...
### Distribution des Catégories de Total Ecological Foorprint par Region
...
### Distribution des Catégories de Total Biocapacity par Region
...
```
### Distribution des Countries_Required par Région
...
###Distribution des terres requises par Région
